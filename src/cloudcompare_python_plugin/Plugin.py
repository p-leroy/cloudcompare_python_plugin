...
class Plugin(pycc.PythonPluginInterface):
    """
    ...
    def getActions(self):
        return [pycc.Action(name="Python Plugin", target=main, icon=(ICON_BYTES, "PNG"))]


def main() -> None:
    """DICE CloudCompare Plugin main action."""

    print("[cloudcompare_python_plugin]")
